function sideImpactSF = SideImpact_3DFEA(thicknessPrimary, thicknessSecondary, maxForce)
    ...
    % Side impact forces (in z direction) at node 18, 20, 26, 31

    Fa(105,1) = (maxForce/4.44822)/4;
    Fa(117,1) = (maxForce/4.44822)/4;
    Fa(153,1) = (maxForce/4.44822)/4;
    Fa(183,1) = (maxForce/4.44822)/4;


    % Boundary conditions, nodes 6,13,17,45,23,25 are all fixed in all directions
    BC = zeros(nnode,ndof_per_node);
    BC(6,1:6) = 1; % 1 means fixed dof
    BC(13,1:6) = 1;
    BC(17,1:6) = 1;
    BC(45,1:6) = 1;
    BC(23,1:6) = 1;
